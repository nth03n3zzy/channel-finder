...
url = "https://www.espn.com/nhl/team/schedule/_/name/det/detroit-red-wings"
headers = {
...
oddRows = doc.find_all('tr', class_='Table__TR Table__TR--sm Table__even')[41]

evenRows = doc.find_all(
    'tr', class_='filled Table__TR Table__TR--sm Table__even')[38]
...
def get_schedule_nhl(tag, class_odd_rows, class_even_rows, url):
    ...
    game = Game(get_team_name_nhl(url), find_date(oddrows[41]), find_opponent(
        oddrows[41]), find_time(oddrows[41], find_date(oddrows[41])), find_channel_nhl(oddrows[r]))
...
print(get_schedule_nhl('tr', 'Table__TR Table__TR--sm Table__even',
                       'filled Table__TR Table__TR--sm Table__even', url))

# print(find_date(oddRows))
# print(find_opponent(oddRows))
#print(find_time(oddRows, find_date(oddRows)))
# print(find_channel_nhl(oddRows))
